...
class SongUNet(torch.nn.Module):
    def __init__(self,
        ...
        for level, mult in enumerate(channel_mult):
            ...
            if level == 0:
                # cin = cout #FIXME: This is for single grey scale image 
                cin = in_channels
                cout = model_channels
                if implicit_mlp:
...
#HACK: This is what we will use for our model change the number of img_channels in this for conditional. 
@persistence.persistent_class
