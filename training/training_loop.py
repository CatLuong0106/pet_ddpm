...
def training_loop(
    ...
    # TODO: This is the code that initializes the network. Change the net_input_channels to match it
    if not four_channels==1:
        ...
        net_input_channels = img_channels + 2 #if no pos encoding, do +0 #TODO: Change this to 2*img_channels + 2 perhaps? 
